...
import time
import logging
from db.database import DB_PATH, CACHE_DB_PATH
...
def _sync_file(path: str, filename: str, last_time_key: str):
    global _last_push_time, _last_cache_push_time
    ...
    try:
        ...
        current_last = _last_push_time if last_time_key == 'db' else _last_cache_push_time
